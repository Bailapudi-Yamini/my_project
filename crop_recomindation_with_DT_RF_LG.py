...
def Prediction2():
    ...
    global Random,random_acc
    #global X_train, X_test, y_train, y_test
    Random1 = RandomForestClassifier(n_estimators=10, criterion="entropy")
    ...
    value = Random1.predict(records)
    print("The Result of fertilizer is:" + str(value))
    text.insert(END,"\n\n")
    text.insert(END, "The Result of fertilizer is: " + str(value) + "\n\n")

    
    
main = tk.Tk()
main.title("Multi-criteria Agriculture Recommendation System using ML for Crop and Fertilizers Prediction") 
main.geometry("1600x1500")

font = ('Book Antiqua Bold', 16, 'bold')
title = Label(main, text='Multi-criteria Agriculture Recommendation System using ML for Crop and Fertilizers Prediction',font=("times"))
...
open_second_button = tk.Button(main,font=(13), text="Get_Crop", command=predict, bg="orange")
open_second_button.place(x=1250, y=650)
open_second_button.config(font=font1)


# Prediction button with color orange
open_second_button = tk.Button(main,font=(13), text="Get_Fertilizer", command=Prediction2, bg="orange")
